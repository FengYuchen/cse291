...
public abstract class Stub
{
        ...
        throws UnknownHostException
    {
        ...
        else if (skeleton.getHostname() == null && !skeleton.getStatus())
            throw new IllegalStateException();
        else if (!c.isInterface() || !RMIExceptionCheck(c))
            throw new Error("This class does not represent a remote interface");
        ...
        Object instance = Proxy.newProxyInstance(c.getClassLoader(), new Class[] {c}, handler);
        return (T) instance;
    }
